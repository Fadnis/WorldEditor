...
namespace World_Editor.DBC
{
    public class AchievementEntry
    {
        ...
        [Localized]
        public string Description;                  // 21-37 If Description is empty, it's not an Achievement but part of the statistics tab
        ...
        public uint Icon;                           // 42
        [Localized]
        public string TitleReward;                  // 43-59
    ...
    public class CfgCategoriesEntry
    {
        ...
        [Localized]
        public string CategoryName;                 // 4-20
    ...
    public class CharStartOutfitEntry
    {
        ...
        [Array(24)]
        public int[] ItemId;                        // 2-25
        [Array(24)]
        public int[] ItemDisplayId;                 // 26-49
        [Array(24)]
        public int[] ItemInventtorySlot;            // 50-73
    ...
    public class CharTitlesEntry
    {
        ...
        [Localized]
        public string NameMale;                     // 2-18
        [Localized]
        public string NameFemale;                   // 19-35
    ...
    public class ChrClassesEntry
    {
        ...
        public string Name;                         // 4-20
        [Localized]
        public string NameFemale;                   // 21-37
        [Localized]
        public string NameNeutral;                  // 38-54
    ...
    public class ChrRacesEntry
    {
        ...
        [Localized]
        public string RaceNameMale;                 // 14-30
        [Localized]
        public string RaceNameFemale;               // 31-47
        [Localized]
        public string RaceNameNeutral;              // 48-64
    ...
    public class CinematicSequencesEntry
    {
        ...
        [Array(8)]
        public uint[] CinematicCamera;              // 2-9
    }
    ...
    public class FactionEntry
    {
        ...
        [Array(4)]
        public uint[] BaseRepRaceMask;              // 2-5
        [Array(4)]
        public uint[] BaseRepClassMask;             // 6-9
        [Array(4)]
        public int[] BaseRepValue;                  // 10-13 Based on 0 = Neutral 
        [Array(4)]
        public uint[] ReputationFlags;              // 14-17
        ...
        [Localized]
        public string Name;                         // 23-39
        [Localized]
        public string Description;                  // 40-56
    ...
    public class HolidaysEntry
    {
        public uint Id;                             // 0
        [Array(10)]
        public uint[] Duration;                     // 1-10
        [Array(26)]
        public uint[] Date;                         // 11-36 (dates in unix time starting at January, 1, 2000)
        public uint Region;                         // 37 (wow region)
        public uint Looping;                        // 38
        [Array(10)]
        public uint[] CalendarFlags;                // 39-48
    ...
    public class ItemExtendedCostEntry
    {
        ...
        [Array(5)]
        public uint[] ReqItem;                      // 4-8
        [Array(5)]
        public uint[] ReqItemCount;                 // 9-13
    ...
    public class ItemRandomPropertiesEntry
    {
        ...
        [Array(5)]
        public uint[] EnchantId;                    // 2-6
        [Localized]
        public string NameSuffix;                   // 7-23
    ...
    public class ItemRandomSuffixEntry
    {
        public uint Id;                             // 0
        [Localized]
        public string NameSuffix;                   // 1-17
        public string InternalName;                 // 18
        [Array(5)]
        public uint[] EnchantId;                    // 19-21
        [Array(5)]
        public uint[] Prefix;                       // 22-26
    }
    ...
    public class SkillLineEntry
    {
        ...
        public string Name;                         // 3-19
        [Localized]
        public string Description;                  // 20-36
        public uint SpellIcon;                      // 37
        [Localized]
        public string AlternateVerb;                // 38-54
    ...
    public class SpellEntry
    {
        ...
        [Array(3)]
        public float[] EffectMultipleValue;         // 101-103  
        [Array(3)]
        public uint[] EffectChainTarget;            // 104-106  
        [Array(3)]
        public uint[] EffectItemType;               // 107-109  
        [Array(3)]
        public int[] EffectMiscValue;               // 110-112  
        [Array(3)]
        public int[] EffectMiscValueB;              // 113-115  
        [Array(3)]
        public uint[] EffectTriggerSpell;           // 116-118  
        [Array(3)]
        public float[] EffectPointsPerComboPoint;   // 119-121
        [Array(9)]
        public float[] EffectSpellClassMask;        // 122-130 
        [Array(2)]
        public uint[] SpellVisual;                  // 131-13
        public uint SpellIconID;                    // 133      
        public uint ActiveIconID;                   // 134      
        public uint SpellPriority;                  // 135      
        [Localized]
        public string SpellName;                    // 136-152  
        [Localized]
        public string Rank;                         // 153-169    
        [Localized]
        public string Description;                  // 170-186
        [Localized]
        public string ToolTip;                      // 187-203 
        ...
        [Array(3)]
        public float[] EffectBonusCoefficient;      // 229-231  
